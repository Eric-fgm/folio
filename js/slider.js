class Slider {
    ...
    translateSlider(translation) {
        ...
        if (document.body.clientWidth >= document.body.clientHeight) {
            let paginationTranslation = translation/(((800+(document.body.clientWidth*0.12)) * 4 + document.body.clientWidth*0.05) - document.body.clientWidth);
            if ( translation < -(((800+(document.body.clientWidth*0.12)) * 4 + document.body.clientWidth*0.05) - document.body.clientWidth)*1/4 && translation > -(((800+(document.body.clientWidth*0.12)) * 4 + document.body.clientWidth*0.05) - document.body.clientWidth)*2/4 ) {
                document.querySelector(".gc-footer-pagination-count-prev").textContent = "02";
            }
            if ( translation < -(((800+(document.body.clientWidth*0.12)) * 4 + document.body.clientWidth*0.05) - document.body.clientWidth)*2/4 && translation > -(((800+(document.body.clientWidth*0.12)) * 4 + document.body.clientWidth*0.05) - document.body.clientWidth)*3/4 ) {
                document.querySelector(".gc-footer-pagination-count-prev").textContent = "03";
            }
            if ( translation < -(((800+(document.body.clientWidth*0.12)) * 4 + document.body.clientWidth*0.05) - document.body.clientWidth)*3/4 ) {
                document.querySelector(".gc-footer-pagination-count-prev").textContent = "04";
            }
    
            document.querySelector(".gc-footer-pagination-range-element").style.transform = 'scaleX(' + -paginationTranslation + ')';
        } else {

            if (translation < -15 ) {
                document.querySelector(".gn-container").classList.add("blur");
            }else {
                document.querySelector(".gn-container").classList.remove("blur");
            }

            const slidee = document.querySelectorAll(".plane-wrapper")[0].offsetHeight + (document.body.clientWidth*0.22);
            let currHeight = slidee * 4;
            let mobildePaginationTranslation = translation/((currHeight + document.body.clientHeight*0.3) - document.body.clientHeight);

            if ( translation < -((currHeight + document.body.clientHeight*0.3) - document.body.clientHeight)*1/4 && translation > -((currHeight + document.body.clientHeight*0.3) - document.body.clientHeight)*2/4 ) {
                document.querySelector(".gc-footer-pagination-count-prev").textContent = "02";
            }
            if ( translation < -((currHeight + document.body.clientHeight*0.3) - document.body.clientHeight)*2/4 && translation > -((currHeight + document.body.clientHeight*0.3) - document.body.clientHeight)*3/4 ) {
                document.querySelector(".gc-footer-pagination-count-prev").textContent = "03";
            }
            if ( translation < -((currHeight + document.body.clientHeight*0.3) - document.body.clientHeight)*3/4 ) {
                document.querySelector(".gc-footer-pagination-count-prev").textContent = "04";
            }

            document.querySelector(".gc-footer-pagination-range-element").style.transform = 'scaleX(' + -mobildePaginationTranslation + ')';
        }
